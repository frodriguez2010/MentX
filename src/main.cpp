...
const string strMessageMagic = "MentX Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    if (nBestHeight > 0 && nBestHeight < 11) //premine 33% supply
    {
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MentX", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "MentX is here February 1, 2020.";
        CTransaction txNew;
        txNew.nTime = 1580593155;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1580593155;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 97818 : 97818;
        ...
        assert(block.hashMerkleRoot == uint256("0x4507baa3f6aa2ee7ef8b5027fe80c7d7637beee676cc369af175e2cbf9e53364"));
    ...
    string strPubKey = "04e399f3f7a0e6480cdd81a8495aa93e60074a3e90beaf39f545d11a3d06def1e57f05f2c908f613c883af1f8347fe9cd416b9e251213043dad054281f1fba389c";
...
unsigned char pchMessageStart[4] = { 0x9d, 0xd1, 0x18, 0xe9 };
